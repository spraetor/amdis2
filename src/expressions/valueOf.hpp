...
namespace AMDiS 
{
  ...
  valueOf(DOFVector<T>& vector) { return {vector}; }
  ...
  valueOf(Matrix<DOFVector<T>*> &mat) { return {mat}; }
  ...
  valueOf(Vector<DOFVector<T>*> &vector) { return {vector}; }
  ...
  componentOf(DOFVector<Vector<T> >& vector, int I) { return {vector, I}; }
