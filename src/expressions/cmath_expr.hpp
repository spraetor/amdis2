...
namespace AMDiS
{
  namespace expressions
  {
    ...
    struct Abs : public LazyOperatorTerms<Term>
    {
      ...
      {
        return std::abs(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("abs(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Signum : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return (Super::getTerm(_0)(iq) > 0.0 ? 1.0 : -1.0);
      }

      std::string str() const
      {
        return std::string("sign(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Ceil : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::ceil(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("ceil(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Floor : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::floor(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("floor(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Pow : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return functors::pow<I,Value_t<Term>>::eval(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("pow<") + std::to_string(I) + ">(" + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Sqrt : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::sqrt(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("sqrt(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Exp : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::exp(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("exp(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Log : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::log(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("log(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Cos : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::cos(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("cos(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Sin : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::sin(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("sin(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Tan : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::tan(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("tan(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Acos : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::acos(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("acos(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Asin : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::asin(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("asin(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Atan : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::atan(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("atan(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Atan2 : public LazyOperatorTerms<Term1, Term2>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::atan2(Super::getTerm(_0)(iq), Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("atan2(") + Super::getTerm(_0).str() + ", " + Super::getTerm(_1) + ")";
      }
    };
    ...
    struct Cosh : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::cosh(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("cosh(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Sinh : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::sinh(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("sinh(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Tanh : public LazyOperatorTerms<Term>
    {
      ...
      value_type operator()(const int& iq) const
      {
        return std::tanh(Super::getTerm(_0)(iq));
      }

      std::string str() const
      {
        return std::string("tanh(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Acosh : public LazyOperatorTerms<Term>
    {
      ...
      std::string str() const
      {
        return std::string("acosh(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Asinh : public LazyOperatorTerms<Term>
    {
      ...
      std::string str() const
      {
        return std::string("asinh(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Atanh : public LazyOperatorTerms<Term>
    {
      ...
      std::string str() const
      {
        return std::string("atanh(") + Super::getTerm(_0).str() + ")";
      }
    };
    ...
    struct Max : public LazyOperatorTerms<Term1, Term2>
    {
      ...
      std::string str() const
      {
        return std::string("max(") + Super::getTerm(_0).str() + ", " + Super::getTerm(_1).str() + ")";
      }
    };
    ...
    struct Min : public LazyOperatorTerms<Term1, Term2>
    {
      ...
      std::string str() const
      {
        return std::string("min(") + Super::getTerm(_0).str() + ", " + Super::getTerm(_1).str() + ")";
      }
    };
  ...
  inline typename enable_if<traits::is_expr<Term>,
         ...
         abs_(Term&& t)
  {
    return {std::forward<Term>(t)};    // TODO: Funktionsnamen ohne Unterstrich
  }
