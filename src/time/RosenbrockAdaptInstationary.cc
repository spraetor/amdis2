...
namespace AMDiS
{
  RosenbrockAdaptInstationary::RosenbrockAdaptInstationary(string name,
      ...
      dbgTimestepStudy(false)
  {
    ...
    string initFileStr(name + "->rosenbrock method");
    string str = Parameters::get<string>(initFileStr, "");
