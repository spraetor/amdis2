...
namespace AMDiS
{
  namespace meta
  {
    ...
    struct LOOP
    {
      ...
      {
        op(at(a, I+shift));
        LOOP<I+1,N>::for_each(a, op, shift);
      }
      ...
      {
        at(b, I+shift) = op(at(a, I+shift));
        LOOP<I+1,N>::transform(a, b, op, shift);
      }
